namespace Excel2Other
{
    ...
    public class JsonSetting : BaseSetting
    {
        ...
        /// 日期格式化字符串
        /// </summary>
        [SettingAttribute("日期格式", "将日期解析成指定格式的字符串")] 
        public string dateFormat;
        /// <summary>
        /// 是否转化Json对象或数组内容的单元格
        /// </summary>
        [SettingAttribute("单元格内的Json解析", "将单元格内的Json字符串进一步解析出来")] 
        public bool JsonCell;

        /// <summary>
        /// 是否将所有的值用字符串表示
        /// </summary>
        [SettingAttribute("内容解析为字符串", "将所有内容都解析成字符串形式")] 
        ...
        /// 是否显示字段为空的项
        /// </summary>
        [SettingAttribute("空单元格保留", "遇到空单元格时，保留字段并赋予默认值")] 
        public bool saveSpace;

        /// <summary>
        /// 是否将Sheet拆开保存
        /// </summary
        [SettingAttribute("根据Sheet拆分文件", "将多个Sheet的Excel文件以Sheet名解析成多个文件")]
