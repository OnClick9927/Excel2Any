...
namespace Sunny.UI
{
    public class UICustomPanel : UIPanel, IToolTip
    {
        ...
        protected override void OnControlAdded(ControlEventArgs e)
        {
            ...
            if (Panel != null && !base.IsDesignMode)
            {
                Add(e.Control);
                return;
            }
        ...
        {
            IStyleInterface styleInterface = control as IStyleInterface;
            if (styleInterface != null && !styleInterface.StyleCustomMode)
            {
                styleInterface.Style = base.Style;
            }
        ...
        public override void SetStyleColor(UIBaseStyle uiColor)
        {
            ...
            Color color2 = (HBar.FillColor = (VBar.FillColor = uiColor.FlowLayoutPanelBarFillColor));
            UIHorScrollBarEx hBar = HBar;
            Color color3 = (VBar.ForeColor = uiColor.FlowLayoutPanelBarForeColor);
            color2 = (scrollBarColor = (hBar.ForeColor = color3));
        }
        ...
        private void InitializeComponent()
        {
            ...
            VBar = new Sunny.UI.UIVerScrollBarEx();
        ...
        private void SetScrollPos()
        {
            ...
            {
                int num = 1;
                if (base.RadiusSides != 0)
                {
                    num = base.Radius / 2;
                }

                VBar.Width = ScrollBarInfo.VerticalScrollBarWidth();
                VBar.Left = base.Width - VBar.Width - num;
                VBar.Top = num;
                VBar.Height = base.Height - num * 2;
